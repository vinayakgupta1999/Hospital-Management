...
p[0].pid="12"; p[0].pname="pankaj"; p[0].disease="cancer"; p[0].gender="male"; p[0].admit_status="y"; p[0].age=30; 
p[1].pid="13"; p[1].pname="kuli"; p[1].disease="cold"; p[1].gender="male"; p[1].admit_status="y"; p[1].age=23; 
p[2].pid="14"; p[2].pname="Gaurav"; p[2].disease="maleriya"; p[2].gender="male"; p[2].admit_status="y"; p[2].age=45; 
p[3].pid="15"; p[3].pname="ravi"; p[3].disease="sugar"; p[3].gender="male"; p[3].admit_status="y"; p[3].age=25; 
